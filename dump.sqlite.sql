...
CREATE TABLE "booktrackerapi_livro" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "titulo" varchar(1000) NOT NULL, "autor" varchar(200) NOT NULL, "adicionado" date NOT NULL, "concluido" date NULL, "nota" integer NOT NULL, "status" integer NOT NULL);
